		...
		<section class="main-content main-content--with-padding main-content--full-width staff-page">
			...
			<div class="row">
				<div class="columns large-8">
					<% if $Photo %>
						<br />
						<img data-interchange="[$Photo.CroppedFocusedImage(400, 300).URL, small], [$Photo.CroppedFocusedImage(600, 400).URL, medium], [$Photo.CroppedFocusedImage(1024, 768).URL, large]">
					<% end_if %>
