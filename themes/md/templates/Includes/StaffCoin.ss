<li>
      ...
      <a href="$Link" class="staff-link">
            <img class="b-lazy staff-img" src=data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw== data-src="$Photo.CroppedImage(350,350).URL" data-src-small="$Photo.CroppedImage(150,150).URL" data-src-medium="$Photo.CroppedImage(250,250).URL" alt="Image showing $FirstName $LastName">
      </a>
      <% else %>
      <a href="$Link" class="staff-link">
