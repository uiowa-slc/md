<li>
	<a href="$Link">
		<img class="b-lazy" src="{$ThemeDir}/images/placeholder.png" data-src="$Image.CroppedFocusedImage(690,440).URL" data-src-small="$Image.CroppedFocusedImage(300,191).URL" data-src-medium="$Image.CroppedFocusedImage(400,255).URL"  alt="$Title">
